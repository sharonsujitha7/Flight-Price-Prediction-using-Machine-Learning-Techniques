...
model = pickle.load(open("flight_predictionN.pkl", "rb"))
...
def predict():
    if request.method == "POST":
        ...
        return render_template('index.html',prediction_text="Your flight price should be Rs. {} approximately.".format(output))
